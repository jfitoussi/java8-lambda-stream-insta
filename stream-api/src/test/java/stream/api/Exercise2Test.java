...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> descOrder = (o1, o2) -> o2.getBudget() - o1.getBudget();
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(descOrder).map(customer -> customer.getName()).limit(3);
