...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> richOrder = (o1, o2) -> o2.getBudget() - o1.getBudget();
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().flatMap(getItemStream.andThen(customer -> customer.map(Item::getName)));
