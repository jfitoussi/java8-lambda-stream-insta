...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Function<Customer, Integer> getAge = Customer::getAge;
        Stream<Integer> sortedAgeStream = customerList.stream().map(getAge).sorted();
    ...
    public void descSortByAge() {
        ...
        Stream<Integer> sortedAgeStream = customerList.stream().map(getAge).sorted(descOrder);
    ...
    public void top3RichCustomer() {
         ...
         */
        Comparator<Customer> descOrder = (customer1, customer2) -> customer2.getBudget() - customer1.getBudget();
    ...
    public void distinctAge() {
         ...
         */
        Function<Customer, Integer> getAge = Customer::getAge;
        Stream<Integer> distinctAgeStream = customerList.stream().map(getAge).distinct();
